...
app.get('/titulos-semelhantes2222/:id', (req, res) => {
    const animeId = req.params.id;

    // Consulta SQL para selecionar os títulos semelhantes ao anime com o ID fornecido
    const query = `
        SELECT 
            id,
            titulo
...
});/// rota retorna titulos semelhante com basse no id enviado 10 catalogos sao retornado
...
app.post('/animes_exibir/:anime_id', (req, res) => {
    ...
    db.run(insertAnimeQuery, [animeId, titulo], function(err) {
        ...
        // Iterar sobre cada episódio e inseri-los individualmente
        episodios.forEach(episodio => {
